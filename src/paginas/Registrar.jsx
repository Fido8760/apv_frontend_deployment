...
const Registrar = () => {
  ...
  const handleSubmit =  async e => {
    ...
    if(password.length < 6) {
      setAlerta({msg: 'El password no puede tener menos de 6 caracteres', error: true });
      return
    }
    ...
    <>
      ...
      <div className=' mt-20 md:mt-5 shadow-lg py-10 px-5 rounded-xl bg-white'>
        ...
        <form onSubmit={handleSubmit} >
          ...
          <div className=" my-5">
            <label className=" uppercase text-gray-600 block text-xl font-bold" htmlFor="">Rpetir Password:</label>
            <input
              type="password"
              className="border w-full p-3 mt-3 bg-gray-50 rounded-xl"
